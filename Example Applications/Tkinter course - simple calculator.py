...
def submit_number(number):
    ...
    #Insert the number or decimal to the display
...
def operate(operator):
    ...
    #Disable all operator button until equal or clear is pressed
...
def equal():
    ...
    #Remove current value of display and update with answer
    display.delete(0, END)
...
def inverse():
    ...
    #Remove the current value in the display and update with answer
    display.delete(0,END)
    display.insert(0, value)
