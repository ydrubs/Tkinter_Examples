...
def remove_item():
    '''Remove the selected (anchor) item from listbox'''
...
def open_list():
    '''Open the list upon starting program if there is one'''
    try:
...
list_clear_button.grid(row=0, column=1, padx=2, pady=1, ipadx=10)
save_button.grid(row=0, column=2, padx=2, pady=1, ipadx=10)
quit_button.grid(row=0, column=3, padx=2, pady=1, ipadx=25)
